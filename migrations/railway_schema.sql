...
CREATE TABLE IF NOT EXISTS financial_settings (
  ...
  debit_fee_pct           NUMERIC(5,2) DEFAULT 1.47,
  credit_1x_fee_pct       NUMERIC(5,2) DEFAULT 3.26,
  credit_2x_fee_pct       NUMERIC(5,2) DEFAULT 11.77,
  credit_3x_fee_pct       NUMERIC(5,2) DEFAULT 13.03,
  credit_4x_fee_pct       NUMERIC(5,2) DEFAULT 13.13,
  credit_5x_fee_pct       NUMERIC(5,2) DEFAULT 15.37,
  credit_6x_fee_pct       NUMERIC(5,2) DEFAULT 15.38,
  credit_7x_fee_pct       NUMERIC(5,2) DEFAULT 17.12,
  credit_8x_fee_pct       NUMERIC(5,2) DEFAULT 17.12,
  credit_9x_fee_pct       NUMERIC(5,2) DEFAULT 19.17,
