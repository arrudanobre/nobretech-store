...
export function buildOrionInput(snapshot: OrionSnapshot, question?: string | null, operationalContext?: OrionOperationalContext | null) {
  ...
  return {
    ...
    instruction: [
      ...
      "Toda estratégia comercial deve sair pronta para execução: produto, preço ideal, piso seguro, oferta, bundle, campanha, criativo, CTA, canal, urgência, risco e meta esperada de lucro.",
