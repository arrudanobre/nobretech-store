...
export function buildOrionInput(snapshot: OrionSnapshot, question?: string | null, operationalContext?: OrionOperationalContext | null) {
  ...
  return {
    ...
    instruction: [
      ...
      "NÃO explique demais. Vá direto ao ponto.",
      ...
      "Responda ao usuário diretamente no chat: 'Hoje eu faria isso: 1. ... 2. ... 3. ...' Sem resumos longos.",
      ...
      // ── Anti-alucinação ──
      "REGRA ABSOLUTA: NUNCA recomende vender ou anunciar um produto que NÃO esteja com status 'active' ou 'in_stock'.",
      "Se não achar o produto exato, trave a ação.",
      ...
      "REGRA 8 — PRESSÃO DE GIRO: 0-15d proteja margem; 16-30d otimize; 31-45d aceite redução; 46d+ liquide o capital.",
