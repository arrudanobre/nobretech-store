...
import { buildWhatsAppLink } from "@/lib/catalog/whatsapp"
...
export function ProductWhatsAppCta({ product, variant = "primary", label = "Falar no WhatsApp" }: Props) {
  const href = buildWhatsAppLink(product)
  const className =
    variant === "sticky"
