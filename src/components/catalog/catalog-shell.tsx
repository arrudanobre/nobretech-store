    ...
    <div className="relative min-h-screen bg-[#050607] text-white">
      ...
      <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-[#050607]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2.5 sm:px-6 sm:py-3">
          <Link href="/catalogo" aria-label="Voltar para o catálogo Nobretech" className="flex items-center gap-2.5">
            <span
              aria-hidden
          ...
          <a
            ...
            aria-label="Falar com a Nobretech no WhatsApp"
